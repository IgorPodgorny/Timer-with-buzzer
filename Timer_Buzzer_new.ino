// Простой таймер с 5 кнопками: 1) Прибавить часы, 2) Убавить часы, 3) Прибавить минуты, 4) Убавить минуты
// 5) Кнопка "старт/стоп" для запуска и остановки таймера и выключения буззера
// Буззер срабатывает при обнулении значения на экране
...
void timeSetting ()
{
  ...
  if (buttonHours == HIGH && addHours == 0) { // если кнопка нажата и переменная addHours (предыдущее состояние кнопки) = 0
  ...
  if (buttonHours == LOW && addHours == 1) { // если кнопка не нажата, т.е., мы её отпустили
  ...
  if (buttonMinutes == HIGH && addMinutes == 0) { // если кнопка нажата и переменная addHours = 0
  ...
  if (buttonMinutes == LOW && addMinutes == 1) { // обработка того, что кнопка отпущена
    addMinutes = 0;
  }
    ...
    if (counterMinutes > 0) { // если минут больше 0, то
      ...
      if (counterHours > 0) { // проверяем, есть ли часы и, если есть, то...
        ...
        while (stopPipping == 0) {
          ...
          if ((millis() - timingPipping > 500) && (millis() - timingPipping < 100)) {
            tone(buzzerPin, 2000, 200);
          }
          if (millis() - timingPipping > 1000 && (millis() - timingPipping < 200)) {
